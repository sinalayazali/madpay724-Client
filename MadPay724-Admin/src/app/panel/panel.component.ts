...
import ScrollBar from '../../assets/vendors/js/perfect-scrollbar.jquery.min.js';
...
export class PanelComponent implements OnInit {
  constructor(private router: Router, private alertSerivce: ToastrService) {}
  ...
  logout(){
    ...
    this.alertSerivce.warning('با موفقیت خارج شدید');
  }
}
